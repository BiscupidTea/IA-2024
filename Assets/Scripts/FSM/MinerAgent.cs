...
public class MinerAgent : Agent
{
        ...
        Node<CoordinateType> Mine)
    {
        ...
        fsm.SetTransition(Behaviours.Move, Flags.OnGoMine, Behaviours.Mining, () =>
        {
            Target = Mine;
            Debug.Log("Mining");
        });
        ...
        fsm.SetTransition(Behaviours.Move, Flags.OnGoTownCenter, Behaviours.Deposit, () => { Debug.Log("Depositing"); });
